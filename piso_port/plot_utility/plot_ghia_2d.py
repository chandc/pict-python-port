...
G = {
 100: dict(
  ...
  v=[0.0,0.09233,0.10091,0.10890,0.12317,0.16077,0.17507,0.17527,0.05454,-0.24533,-0.22445,-0.16914,-0.10313,-0.08864,-0.07391,-0.05906,0.0]),
 400: dict(
  y=[0.0,0.0547,0.0625,0.0703,0.1016,0.1719,0.2813,0.4531,0.5,0.6172,0.7344,0.8516,0.9531,0.9609,0.9688,0.9766,1.0],
...
d = np.load("results/cavity_2d.npz")
def line(tag):
    n = int(d["N"]); m = n // 2
...
fig.savefig("figures/cavity_2d_vs_ghia.png", dpi=170, facecolor=SURFACE)
