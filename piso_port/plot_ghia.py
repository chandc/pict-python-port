...
GHIA_V = [0.00000, 0.07027, 0.08344, 0.09233, 0.10091, 0.16077, 0.17507, 0.17527,
...
try:
    c = dict(np.load("cavity_cartesian.npz"))
    try:
        c.update(dict(np.load("cavity_cart40.npz")))
...
fig.savefig("cavity_vs_ghia.png", dpi=170, facecolor=SURFACE)
